...
<input type="text" name="TenSach" class="form-control" value={{$sach->TenSach??''}}/>
 </div>
</div>
<div class="row form-group">
    <label class="col-md-2">
...
<div class="row form-group">
 ...
 <input type="text" name="GiaSach" class="form-control" value={{$sach->GiaSach??''}}/>
    </div>
    <label class="col-md-2">
    Tác giả: 
    </label>
    <div class="col-md-4">
    <input type="text" name="TacGia" class="form-control" value={{$sach->TacGia??''}}/>
    </div>
</div>
<div class="row form-group">
